...
uint64          kvmpa(uint64,pagetable_t);
void            kvmmap(uint64, uint64, uint64, int, pagetable_t);
...
void            kvm_free_pageble(pagetable_t);
int             u2vkvmcopy(pagetable_t,pagetable_t,uint64,uint64);
